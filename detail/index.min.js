    ...
    $.ajax({
      ...
      success: function (e) {
        ...
        if (e.code == "0") {
          ...
          if (e.data.source == "") {
            source = `<div class="col-3 content-subtitle">未知来源</div>`;
          } else {
            source = `<div class="col-3 content-subtitle">来自于 ${e.data.source}</div>`;
          }
          if (e.data.ptime == "") {
            post_t = "";
          } else {
            post_t = `<div class="col-3 content-subtitle">发表于 ${e.data.ptime}</div>`;
          }
          if (e.data.images == null) {
            img_show += `
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../images/no_image.jpg" class="d-block w-100 img-list" alt="...">
              </div>
            </div>
            ...
            for (let index = 0; index < e.data.images.length; index++) {
              ...
              if (index == "0") {
                img_list += `
                          <div class="carousel-item active">
                  <img src="${e.data.images[index].imgSrc}" class="d-block w-100 img-list" alt="...">
                </div>`;
              } else {
          ...
          detail_show += `<div class="col-6"></div>` + source + post_t;
          $("#news_title").html("");
