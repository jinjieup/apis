...
window.onload = function () {
  ...
  var settings = {
    "url": "https://www.mxnzp.com/api/ip/self?app_id=rgihdrm0kslojqvm&app_secret=WnhrK251TWlUUThqaVFWbG5OeGQwdz09",
    "method": "GET",
    "timeout": 0,
  };  
  $.ajax(settings).done(function (response) {
    console.log(response);
    sender_info_format = "发件者ip:"+response.data.ip+"  详细信息："+response.data.desc;
    console.log("sender info: ",sender_info_format);
  });
  get_verify_image();
};
...
function send_mail(){
  var address = document.getElementById("address").value;
  var title = document.getElementById("title").value;
  var content =  sender_info_format+"\n\n"+document.getElementById("content").value;
